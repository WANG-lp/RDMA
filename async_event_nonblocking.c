 ...
 * SOFTWARE.
 *
 * async_event_nonblocking -- program that reads the async events in non
 * blocking way and prints them.
 *
 * Compilation:
 *    gcc async_event_nonblocking.c -o async_event_nonblocking -libverbs
 *
 * Running:
 *    ./async_event_nonblocking -d <RDMA device>
 */
